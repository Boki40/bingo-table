...
export const games: Game[] = [
    ...
    {
        cimke: "Feladat",
        szoveg: "Igyál [k] kortyot, miközben a tőled balra ülő játékos a füledbe suttog.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "%s csukd be a szemed és próbálj felismerni minden játékost az illatáról! Igyál [k] kortyot, ha nem sikerül.",
    },
    {
        cimke: "Feladat",
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "Igyál annyi kortyot, ahány játékos alacsonyabb nálad!",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Igyál annyi kortyot, ahány játékos barnább nálad!",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Igyál annyi kortyot, ahány játékos fehérebb nálad!",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Igyál annyi kortyot, ahány játékos idősebb nálad!",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Igyál annyi kortyot, ahány játékos fiatalabb nálad!",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Igyál annyi kortyot, ahány játékos magasabb nálad!",
    },
    {
        cimke: "Feladat",
    ...
    {
        cimke: "Feladat",
        szoveg: "Akiknél ez a szám szerepel, egyezzenek meg, hogy kinek osztanak ki [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg: "Nézz farkasszemet a tőled jobbra ülővel. Ha veszítesz, [k] kortyot iszol.",
    },
    {
        cimke: "Feladat",
        szoveg: "Igyál [k] kortyot!",
    ...
    {
        cimke: "Feladat",
        szoveg: "Felelsz, mersz vagy iszol [k] kortyot? A tőled balra ülő tehet fel egy kérdést neked!",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "5 körig csendben kell maradnod, vagy húzd le az italod!",
    },
    {
        cimke: "Feladat",
        szoveg:
            "%s, ha dohányzol, dobj el egy cigit a kukába vagy igyál [k] kortyot!",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 One Direction dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 Avril Lavigne dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 Lady Gaga dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 Lagzi Lajcsi dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 Linkin Park dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 Zámbó Jimmy dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 SP dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 Selena Gomez dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondd el 3 Twenty One Pilots dal címét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    {
        cimke: "Feladat",
        szoveg: "A tőled balra ülő játékos annyi kortyot itathat veled, amennyit szeretne, és ő tartja a poharat!",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Jelölj ismerősnek 10 embert Facebookon, vagy igyál [k] kortyot!",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "Lájkold az első 15 bejegyzés Facebookon, vagy igyál [k] kortyot!",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    {
        cimke: "Feladat",
        szoveg: "Mondd meg a tőled jobbra ülő csillagjegyét, vagy igyál [k] kortyot!",
    },
    {
        cimke: "Feladat",
        szoveg: "Mondd meg a tőled balra ülő kedvenc színét, vagy igyál [k] kortyot!",
    },
    {
        cimke: "Feladat",
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mondj mindenkihez egy gyengeséget, és igyál is mindegyik mellé!",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "%s, mosolyogj egy percig megállás nélkül. [k] kortyot iszol ha abbahagyod idő előtt!",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "Mutasd meg az utolsó öt képet a mobilodon vagy igyál [k] kortyot!",
    },
    {
        cimke: "Feladat",
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "Igyál annyi kortyot, ahány pohár italt megittatok már összesen.",
    },
    {
        cimke: "Feladat",
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "Igyál annyi kortyot, ahány vörös ruhát viselsz!",
    },
    {
        cimke: "Feladat",
        szoveg:
            " Igyál [k] kortyot, ha nincs rajtad vörös ruha!",
    },
    {
        cimke: "Feladat",
        szoveg: "Sorold fel a tőled balra ülő legalább 3 exét, vagy igyál [k] kortyot.",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    },
    {
        cimke: "Feladat",
        szoveg:
            "Énekelj egy Justin Bieber dalrészletet, vagy igyál [k] kortyot!",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    {
        cimke: "Feladat",
        szoveg: "Akinek nagyobb a tenyere azok közül akiknél szerepel ez a szám, az [k] kortyot iszik.",
    },
    {
        cimke: "Feladat",
        szoveg:
            "Érintsd meg az orrodat a nyelveddel, vagy igyál [k] kortyot!",
    },
    {
        cimke: "Feladat",
        szoveg:
    ...
    },
    {
        cimke: "Játék",
        szoveg:
            "%s igyál [k] kortyot, ha szólt már rád tanár órán, mert nem figyeltél vagy beszélgettél!",
    },
    {
        cimke: "Játék",
    ...
    },
    {
        cimke: "Játék",
        szoveg:
            "%s által viselt színek, aki először kifogy a ötletekből az [k] kortyot iszik! %s kezdi!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s és %s közül igyon az [k] kortyot, aki hosszabb párkapcsolatban él vagy élt!",
    },
    {
        cimke: "Játék",
        szoveg: "%s és %s közül igyon az [k] kortyot, aki többet volt szingli!",
    },
    {
        cimke: "Játék",
        szoveg: "%s és %s szkanderezik. A vesztes iszik [k] kortyot.",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s és %s, aki közületek legutóbb ült repülőn, kioszthat [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg: "%s és %s, igyatok [k] kortyot, ha nyögtetek ma már!",
    },
    {
        cimke: "Játék",
        szoveg: "%s! Ha szerinted cukibb vagy mint %s, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, 10 után keltél délelőtt? Ha igen, igyál [k] kortyot, ha nem, akkor ossz ki [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, Fordot vezetsz? Ha igen, ossz ki [k] kortyot! Ha nem, te iszod meg!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, Toyotát vezetsz? Ha igen, ossz ki [k] kortyot! Ha nem, te iszod meg!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, akik nem ismerőseid Facebookon, isznak [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, akik nem ismerőseid Snapchaten, isznak [k] kortyot! Ha nincs Snapchated, te iszol [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, akik nem követnek téged Instagramon, isznak [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, amíg nem látod újra a neved a képernyőn, igyál minden körben egyet!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, dönts: szerinted ki szerzett már több egyest élete során? %s vagy %s? A bukott diák [k] kortyot iszik.",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha %s aludt már nálad, ossz ki [k] kortyot! Ha még nem, igyál te!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, ha 2-nél kevesebb pohárral ittál ma eddig, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, ha 2-nél több pohárral ittál ma eddig, ossz ki [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha a korod egy páros szám, igyál [k] kortyot, ha páratlan, akkor itass [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha a legutóbbi bulidban volt olyan, hogy az egyik kezedben cigi, a másikban alkohol volt, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, ha a lábaid nincsenek leborotválva, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha a szüleid kidíszítik a házat kívülről karácsonyra minden évben, igyál [k] kortyot! Ha nem, ossz ki [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha a telefonod a zsebedben van, igyál [k] kortyot! Ha nem, ossz ki [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha adtál már valakinek több mint 1500 Ft borravalót, ossz ki [k] kortyot! Ha még nem, igyál te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha aludtál már %s&val egy szobában buli után, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha aludtál már el ülő pozícióban egy klubban, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha az első aktusod 16 éves korod után történt, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha birkóztál már %s&val, ossz ki [k] kortyot! Ha még nem, igyál te!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, ha dobtak már, igyál [k] kortyot! Ha nem, oszd ki!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha dobtál már valakit telefonon, igyál [k] kortyot! Ha még nem, oszd ki!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha ejtetted már bele a telefonod a WC-be, ossz ki [k] kortyot! Ha még nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha ez az első italod, idd meg a felét! Ha nem, kioszthatsz [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha fejeztél már be Rubik kocka kirakást, akkor ossz ki [k] kortyot! Ha nem, te iszod meg.",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha flip flop papucs van rajtad, ossz ki [k] kortyot! Ha nem, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha grilleztél már %s&val, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, ha göndör hajad van, ossz ki [k] kortyot! Ha nem, te iszol!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha hajnali 5 előtt értél haza a legutóbbi bulidból, igyál [k] kortyot! Ha nem, ossz ki [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha hajnali 6-nál tovább maradtál a legutóbbi bulidban, ossz ki [k] kortyot! Ha nem, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha használtad a lift helyett a lépcsőt a héten, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha használtál dezodort mielőtt idejöttél, ossz ki [k] kortyot! Ha nem, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha használtál már levelet papír helyett a WC-n, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha hazudtál már a korodról, hogy kapj alkoholt, ossz ki [k] kortyot! Ha nem, te iszol!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha hosszú szép hajad van, ossz ki [k] kortyot! Ha nem, te iszol!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha hánytál már kocsmában vagy szórakozóhelyen, ossz ki [k] kortyot! Ha nem, te iszol!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha hívtad már meg %s-t egy házibuliba hozzád, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha húztál már le röviditalokat %s&val, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha ijedtél már meg póktól, ami kisebb volt, mint a körmöd, igyál [k] kortyot! Ha még nem, akkor oszd ki!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha ismersz egy Justin Bieber szöveget, igyál [k] kortyot! Ha nem, ossz ki [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha ittál már meg %s&val egymás után több rövidet, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha kisebb a lábad, mint %s lába, akkor igyál [k] kortyot, ha nem, akkor ossz ki [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha követed Kardashian-ék életét vagy valami még rosszabb reality műsort, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha követed az Koccot Instán, kioszthatsz [k] kortyot! Ha nem, kövesd be, vagy igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha legutóbb otthon vizeltél, igyál [k] kortyot! Ha nem, ossz ki [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, ha loptál már boltból, ossz ki [k] kortyot! Ha nem, te iszol!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, ha lány vagy ossz ki [k] kortyot, ha nem igyál ennyit!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha láttad már, ahogy %s lehúz egy röviditalt, ossz ki [k] kortyot! Ha nem, idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha láttál már valamit, amit a tudomány vagy a fizika nem tud megmagyarázni, ossz ki [k] kortyot! Ha nem, igyál te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha mentettél már meg egy vadon élő állatot, ossz ki [k] kortyot! Ha nem, igyál te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha már aludtál %s lakásán, ossz ki [k] kortyot! Ha még nem, igyál te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha már ettél a McDonald's-ban 6000 Ft-nál többért, ossz ki [k] kortyot! Ha még nem, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg: "%s, ha már kezdtél verekedést, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha már szartál az iskolában vagy a munkahelyeden, igyál [k] kortyot. Ha nem, akkor igyál [k] kortyot.",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha már több mint 3 embert dobtál, igyál [k] kortyot! Ha még nem, akkor idd meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha már vezettél idegen országban, ossz ki [k] kortyot! Ha még nem, igyál te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha még nem volt lófarkas frizurád, ossz ki [k] kortyot! Ha már igen, te iszol!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha még soha nem borotváltad le a szakálladat, igyál [k] kortyot. Ha igen, akkor oszd ki!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha nem szereted a keresztneved, kárpótlásként kioszthatsz [k] kortyot! Ha szereted, igyál [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha nem szeretsz szarni, mikor a párod a közeledben van, igyál [k] kortyot! Oszd ki, ha nem zavar!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha nem szívószállal iszol, ossz ki [k] kortyot! Ha igen, te igyál ennyit!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha nem vagy szingli és a pároddal vagy itt, ossz ki [k] kortyot! Ha nem, te iszol!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha nem vettél még 85 ezer forintnál drágább telefont, igyál [k] kortyot. Ha már igen, akkor oszd ki!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha nincs szakállad, igyál [k] kortyot! Ha nem, oszd ki a [k] kortyot!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha néztél már végig baseball, vagy kosármeccset teljesen, ossz ki [k] kortyot! Ha nem, igyál te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha oktattál már valamit diákoknak, ossz ki [k] kortyot! Ha nem, idd meg meg te!",
    },
    {
        cimke: "Játék",
        szoveg:
            "%s, ha rendeztél már egy rövid filmet, vagy szerepeltél benne, igyál [k] kortyot! Ha nem, oszd ki!",
    },
    {
        cimke: "Játék",
        szoveg:
