...
export default function GamePage() {
    ...
    return <div className="bg-slate-900 p-5 flex flex-col items-center relative">
        ...
        <div
            ...
            <div
                ...
                {revealedIndexes.map((number, index) =>
                    <div
                        className="bg-yellow-600 rounded-full min-w-[2.5rem] w-[2.6rem] h-[2.6rem] text-md transition h-8 border border-solid border-black leading-9"
        ...
        <div
            className="bg-white grid-cols-2 lg:grid-cols-3 grid gap-4 p-4 w-full">
